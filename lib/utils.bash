...
# NOTE: You might want to remove this if danger-swift is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if danger-swift has other means of determining installable versions.
	list_github_tags
}
...
download_release() {
	...
	# TODO: Adapt the release URL convention for danger-swift
